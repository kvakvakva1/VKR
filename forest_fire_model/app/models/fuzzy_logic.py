...
class FuzzyFireController:
    ...
    def _setup_membership_functions(self):
        # Скорость ветра - 5 категорий
        self.wind_speed['calm'] = fuzz.trapmf(self.wind_speed.universe, [0, 0, 2, 5])
        self.wind_speed['light'] = fuzz.trapmf(self.wind_speed.universe, [2, 5, 10, 12])
        self.wind_speed['moderate'] = fuzz.trapmf(self.wind_speed.universe, [10, 12, 15, 18])
        self.wind_speed['strong'] = fuzz.trapmf(self.wind_speed.universe, [15, 18, 22, 25])
        self.wind_speed['storm'] = fuzz.trapmf(self.wind_speed.universe, [22, 25, 30, 30])
    ...
    def _setup_rules(self):
        ...
        wind_categories = ['calm', 'light', 'moderate', 'strong', 'storm']
        ...
        def get_fire_prob_level(temp, wind, humidity, neighbors):
            ...
            wind_weights = {'calm': 1, 'light': 2, 'moderate': 3, 'strong': 4, 'storm': 5}
